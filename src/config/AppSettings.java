 ...
 * ASCII, don't skip startup dialog, lastBytes 0, lastBurst 1).
 */
public final class AppSettings {
    ...
    private static final String KEY_LAST_BURST            = "lastBurst";
    ...
    public static final int      DEFAULT_LAST_BURST           = 1;
    ...
    /**
     * Last-used dump dialog Burst value ({@code 1}..{@code 99}); unset prefs default to
     * {@link #DEFAULT_LAST_BURST}.
     */
    public int getLastBurst() {
        return prefs.getInt(KEY_LAST_BURST, DEFAULT_LAST_BURST);
    }

    public void setLastBurst(int burst) {
        prefs.putInt(KEY_LAST_BURST, burst);
    }
